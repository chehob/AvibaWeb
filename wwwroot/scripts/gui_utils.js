                ...
                success: function (result) {                    
                    ...
                    const docDefinition = {
                        content: [
                            ...
                            {
                                text: `ООО "АВИБА.РУ" - аккредитованное в Транспортной Клиринговой Палате РФ и в Международной Ассоциации Воздушного Транспорта агентство, в лице Генерального директора Грибенника Виталия Борисовича, действующего на основании Устава, именуемое в дальнейшем «Исполнитель», с одной стороны и ${result.corporatorName}, в лице ${result.managementPositionGenitive} ${result.managementNameGenitive}, действующего на основании Устава, именуемое в дальнейшем «Заказчик», с другой стороны, вместе именуемые «Стороны», заключили настоящий Договор о нижеследующем:`,
                                style: 'mediumText',
                                alignment: 'justify',
                                margin: [0, 10, 0, 0]
                            },
                            ...
                            },
                            {
                                stack: [
                                    ...
                                    { text: `9.4.2. Адрес Исполнителя: ООО "АВИБА.РУ", 308010, г Белгород, пр-кт Б.Хмельницкого, д 166` },
                                    { text: ' ' },
                                        ...
                                        [
                                            {
                                                stack: [
                                                    { text: 'ИСПОЛНИТЕЛЬ:', },
                                                    { text: 'ООО "АВИБА.РУ"', bold: true },
                                                    { text: [ { text: 'Адрес местонахождения: ', bold: true }, '308010, г Белгород, пр-кт Б.Хмельницкого, д 166'] },
                                                    { text: [ { text: 'ИНН: ', bold: true }, '3123298618'] },
                                                    { text: [ { text: 'КПП: ', bold: true }, '312301001'] },
                                                    { text: [ { text: 'ОГРН: ', bold: true }, '1123123005180'] },
                                                    { text: ' ' },
                                                    { text: [ { text: 'Р/c: ', bold: true }, '40702810700000086792 в АО «Райффайзенбанк» г. Москва'] },
                                                    { text: [ { text: 'К/с: ', bold: true }, '30101810200000000700'] },
                                                    { text: [ { text: 'БИК: ', bold: true }, '044525700'] },
                                                    { text: [ { text: 'Телефон: ', bold: true }, '+74722232723'] },
                                                ]
                                            },
                                            {
                                                text: ' '
                                        ...
                                        [
                                            {
                                                stack: [
                                                    ...
                                                    { text: ' ' },
                                                    { text: ' ' },
                                                    { text: '__________________________/ Грибенник В.Б. /'},
                                                    { text: ' ' },
                                                    { text: 'М.П.' },
                                                ]
                                            },
