...
namespace AvibaWeb.Migrations
{
    ...
    [Migration("20220218035630_MCounterpartyProxy_Initial")]
    partial class MCounterpartyProxy_Initial
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels._1CUpload", b =>
                {
                    b.Property<int>("_1CUploadId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("UploadVersion");

                    b.HasKey("_1CUploadId");

                    b.ToTable("_1CUploads");
                });

            modelBuilder.Entity("AvibaWeb.DomainModels._1CUploadData", b =>
                {
                    b.Property<int>("_1CUploadDataId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("CounterpartyId");

                    b.Property<string>("PrincipalDocumentName");

                    b.HasKey("_1CUploadDataId");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.AtolPrintSettings", b =>
                {
                    b.Property<int>("AtolPrintSettingsId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AtolServerAddress");

                    b.Property<string>("AtolServerName");

                    b.Property<string>("CashierName");

                    b.Property<string>("DeskBinding");

                    b.Property<bool>("IsPermanent");

                    b.Property<int>("PrintLuggagePercentage");

                    b.Property<int>("PrintPercentage");

                    b.HasKey("AtolPrintSettingsId");

                    b.ToTable("AtolPrintSettings");
                });

            modelBuilder.Entity("AvibaWeb.DomainModels.BMDeskGroup", b =>
                {
                    b.Property<int>("BMDeskGroupId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("BMDeskGroupId");

                    b.ToTable("BMDeskGroups");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.CorporatorDocumentFeeItem", b =>
                {
                    b.Property<int>("CorporatorDocumentFeeItemId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int>("CorporatorDocumentId");

                    b.Property<string>("FeeStr");

                    b.Property<string>("Name");

                    b.HasKey("CorporatorDocumentFeeItemId");

                    b.HasIndex("CorporatorDocumentId");

                    b.ToTable("CorporatorDocumentFeeItems");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.CorporatorReceipt", b =>
                {
                    ...
                    b.Property<int>("VirtualSegCount");

                    b.Property<int?>("WebSiteSubGroupId");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.CorporatorReceiptTemplate", b =>
                {
                    b.Property<int>("CorporatorReceiptTemplateId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CorporatorReceiptTemplateId");

                    b.HasIndex("OrganizationId");

                    b.ToTable("CorporatorReceiptTemplates");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.Counterparty", b =>
                {
                    ...
                    b.Property<string>("ProxyDocument");

                    b.Property<string>("ProxyName");

                    b.Property<string>("ProxyPosition");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.FinancialAccountOperation", b =>
                {
                    ...
                    b.Property<string>("FactualCounterpartyId");
                    ...
                    b.HasIndex("FactualCounterpartyId");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.Income", b =>
                {
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.IncomeOperation", b =>
                {
                    b.Property<int>("IncomeOperationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.LoanExpenditure", b =>
                {
                    b.Property<int>("LoanExpenditureId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LoanExpenditureId");

                    b.ToTable("LoanExpenditures");
                });

            modelBuilder.Entity("AvibaWeb.DomainModels.LoanExpenditureOperation", b =>
                {
                    b.Property<int>("LoanExpenditureOperationId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LoanExpenditureOperationId");

                    b.HasIndex("LoanExpenditureId");

                    b.ToTable("LoanExpenditureOperations");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.Organization", b =>
                {
                    ...
                    b.HasIndex("_1CUploadDataId");

                    b.ToTable("Organizations");
                });

            modelBuilder.Entity("AvibaWeb.DomainModels.PKReceiptRule", b =>
                {
                    b.Property<int>("PKReceiptRuleId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<decimal>("Rate");

                    b.HasKey("PKReceiptRuleId");

                    b.ToTable("PKReceiptRules");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.S7ProviderBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.SubagentFeeTransaction", b =>
                {
                    b.Property<int>("SubagentFeeTransactionId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("SubagentFeeTransactionId");

                    b.HasIndex("SubagentId");

                    b.ToTable("SubagentFeeTransactions");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.CorporatorDocumentFeeItem", b =>
                {
                    b.HasOne("AvibaWeb.DomainModels.CorporatorDocument", "CorporatorDocument")
                        .WithMany()
                        .HasForeignKey("CorporatorDocumentId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.Desk", b =>
                {
                    b.HasOne("AvibaWeb.DomainModels.BMDeskGroup", "BMDeskGroup")
                        .WithMany("Desks")
                        .HasForeignKey("BMDeskGroupId");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.FinancialAccountOperation", b =>
                {
                    ...
                    b.HasOne("AvibaWeb.DomainModels.Counterparty", "FactualCounterparty")
                        .WithMany()
                        .HasForeignKey("FactualCounterpartyId");
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.IncomeOperation", b =>
                {
                    b.HasOne("AvibaWeb.DomainModels.Income", "Income")
                        .WithMany("Operations")
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.LoanExpenditureOperation", b =>
                {
                    b.HasOne("AvibaWeb.DomainModels.LoanExpenditure", "LoanExpenditure")
                        .WithMany()
                        .HasForeignKey("LoanExpenditureId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.Organization", b =>
                {
                    ...
                    b.HasOne("AvibaWeb.DomainModels._1CUploadData", "_1CUploadBinding")
                        .WithMany()
                        .HasForeignKey("_1CUploadDataId");
                });
            ...
            modelBuilder.Entity("AvibaWeb.DomainModels.SubagentFeeTransaction", b =>
                {
                    b.HasOne("AvibaWeb.DomainModels.SubagentData", "SubagentData")
                        .WithMany()
                        .HasForeignKey("SubagentId");
                });
